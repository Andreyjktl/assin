...
<div class="right_container">
  ...
  <?php } ?>
      ...
      <div id="content_front_page" data-animation ="<?php echo $content_post_turn_on_animation ? 0 : 1;?>">
        ...
        <div id="image_list_top0" class="image_list_top portfolio_list " data-animation ="<?php echo $home_middle_description_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::home_featured_post(); ?></div>
        <div id="image_list_top1" class="image_list_top portfolio_list " data-animation ="<?php echo $blog_posts_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::blog_posts_section(); ?></div>
        <div id="image_list_top2" class="image_list_top portfolio_list " data-animation ="<?php echo $gallery_posts_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::gallery_posts_section(); ?></div>
        <div id="image_list_top3" class="image_list_top portfolio_list " data-animation ="<?php echo $review_posts_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::review_posts_section(); ?></div>
        <div id="image_list_top5" class="image_list_top portfolio_list " data-animation ="<?php echo $pinned_post_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::pinned_posts_section(); ?></div>
        <div id="image_list_top6" class="image_list_top portfolio_list " data-animation ="<?php echo $social_links_turn_on_animation ? 0 : 1;?>"><?php sauron_frontend_functions::social_icons_section(); ?></div>
      <?php
    wp_reset_query(); ?>
      <div class="clear"></div>
    </div>
